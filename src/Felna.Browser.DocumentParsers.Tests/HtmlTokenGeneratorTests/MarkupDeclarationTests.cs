...
public class MarkupDeclarationTests
{
    ...
    [DataRow("<!doctype html public 'pid' \"sid\">", @"[{""type"":""doctype"",""name"":""html"",""publicidentifier"":""pid"",""systemidentifier"":""sid""}]")]
    [DataRow("<!doctype html public 'pid' \"sid\" >", @"[{""type"":""doctype"",""name"":""html"",""publicidentifier"":""pid"",""systemidentifier"":""sid""")]
    [DataRow("<!doctype html system \"sid\"", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid"",""forcequirks"":true}]")]
    [DataRow("<!doctype html system \"sid\" ", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid"",""forcequirks"":true}]")]
    [DataRow("<!doctype html system \"sid\">", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid""}]")]
    [DataRow("<!doctype html system \"sid\" >", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid""")]
    [DataRow("<!doctype html system 'sid'", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid"",""forcequirks"":true}]")]
    [DataRow("<!doctype html system 'sid' ", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid"",""forcequirks"":true}]")]
    [DataRow("<!doctype html system 'sid'>", @"[{""type"":""doctype"",""name"":""html"",""systemidentifier"":""pid""}]")]
